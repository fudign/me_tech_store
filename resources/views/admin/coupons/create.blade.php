...
<div class="container mx-auto px-4 py-8">
    ...
    <h1 class="text-3xl font-bold mb-6">Создать купон</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        <option value="fixed" {{ old('type') === 'fixed' ? 'selected' : '' }}>Фиксированная сумма</option>
                        <option value="percentage" {{ old('type') === 'percentage' ? 'selected' : '' }}>Процент от суммы</option>
                    </select>
                    @error('type')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           placeholder="Для фикс: 100, для %: 10">
                    <p class="text-xs text-gray-500 mt-1">Для фиксированной - сумма в сомах, для процента - от 1 до 100</p>
                    @error('value')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Применяется только для процентных купонов</p>
