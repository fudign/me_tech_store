...
<body class="bg-gray-100 font-sans antialiased">
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('admin.orders.index') }}"
                   class="flex items-center px-6 py-3 {{ request()->routeIs('admin.orders.*') ? 'bg-gray-800 border-l-4 border-blue-500' : 'hover:bg-gray-800' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.products.index') }}"
                   class="flex items-center px-6 py-3 {{ request()->routeIs('admin.products.*') ? 'bg-gray-800 border-l-4 border-blue-500' : 'hover:bg-gray-800' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.categories.index') }}"
                   class="flex items-center px-6 py-3 {{ request()->routeIs('admin.categories.*') ? 'bg-gray-800 border-l-4 border-blue-500' : 'hover:bg-gray-800' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col min-h-screen">
            ...
            <!-- Main Content Area -->
            <main class="flex-1 bg-gray-100 pb-6">
                @if(session('success'))
